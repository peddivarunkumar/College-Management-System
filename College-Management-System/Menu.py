...
def __marksheet__():
       filename = "C:\College_management_System\College-Management-System\Search_Page.py"
       os.system(filename)
       os.system('notepad'+filename)

def __Library__():
       filename = "C:\College_management_System\College-Management-System\Library_Frontend.py"
       os.system(filename)
       os.system('notepad'+filename)

def __information__():
       filename = "C:\College_management_System\College-Management-System\Std_info_FrontEnd.py"
       os.system(filename)
       os.system('notepad'+filename)

def __FeeReport__():
       filename = "C:\College_management_System\College-Management-System\Fee_Frontend.py";
       os.system(filename)
       os.system('notepad'+filename)
